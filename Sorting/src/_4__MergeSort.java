...
//     4. Merge the two half sorted in step 2 and 3: merge(arr, l, m, r)
    ...
    // I keep dividing array until individual ele are remaining in the range
    ...
    // then space will be free, we utilize these space to call right half (right half don't use new extra space)
